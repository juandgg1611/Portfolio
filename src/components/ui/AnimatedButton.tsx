  ...
  return (
    <div ref={containerRef} className="inline-block p-8 -m-8 pointer-events-auto">
      <Component
        ...
        disabled={disabled}
        className={`relative text-sm md:text-base outline-none overflow-hidden h-12 md:h-14 px-6 sm:px-8 md:px-10 rounded-full ${bgColor} ${textColor} ${borderColor} group cursor-pointer font-semibold inline-block ${className}`}
